...
def test_controller_cache_hit(mock_commits: MagicMock, mock_meta: MagicMock, mock_save_meta: MagicMock, mock_save: MagicMock, mock_load_meta: MagicMock, mock_load: MagicMock) -> None:
    # Mock cache hit
...
@patch("src.presentation.controller.fetch_repo_metadata")
@patch("src.presentation.controller.fetch_commits")
def test_controller_cache_miss(mock_commits: MagicMock, mock_meta: MagicMock, mock_save_meta: MagicMock, mock_save: MagicMock, mock_load_meta: MagicMock, mock_load: MagicMock) -> None:
    # Mock cache miss
...
@patch("src.presentation.controller.load_metadata_cache")
@patch("src.presentation.controller.fetch_repo_metadata")
def test_controller_api_error(mock_meta: MagicMock, mock_load_meta: MagicMock, mock_load: MagicMock) -> None:
    mock_load.side_effect = [None, None]
    mock_load_meta.return_value = None
